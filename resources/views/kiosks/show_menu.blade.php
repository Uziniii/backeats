...
<body class="h-[100vh]">
    <main style="background-image: url({{asset(" /backgroundKiosk.png")}})" id="backgroundKiosk"
        class="bg-cover flex bg-repeat h-[100vh]">
        <div id="startKiosk" style="background-image: url({{asset(" /backgroundKiosk.png")}})"
            class="flex flex-col h-full  justify-center w-full absolute bg-cover flex bg-repeat hidden">
        ...
        <div class="w-[70%] h-full p-[30px]">
            <div class="w-full h-full flex items-center flex-col justify-center">
                ...
                <ul class="bg-[#805C3A] p-[50px] rounded-md">
                    ...
                    <li>Image: <img src="{{ Storage::url($menu->image) }}" alt="{{ $menu->name }}" /></li>
            ...
            <div class="w-full h-[70%] gap-[20px] flex flex-col items-center">
                ...
                <a href="{{ route('kiosk_menus_by_category', ['token' => $token, 'category_id' => $categorie->id]) }}">
                    <article class="flex flex-col items-center">
                        <img class="w-[170px] h-[130px]" src="{{ URL::asset($categorie->image) }}"
