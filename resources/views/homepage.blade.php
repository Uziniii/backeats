...
<body class="overflow-x-hidden box-border p-0 m-0 scroll-smooth">
        ...
        <div id="articles-container" class="w-screen h-[60rem] flex flex-col justify-around items-center mt-10 gap-6">
            ...
            <article class="w-[70%] h-[22rem] flex justify-between items-center">
                ...
                <div id="article-content-container--right" class="w-[30rem] flex flex-col gap-4">
                    ...
                    <p id="article-text">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt, similique asperiores. Illum
                        iusto inventore omnis ipsum odit delectus optio, repellendus ipsa error numquam quod
                        necessitatibus sequi, tenetur unde dignissimos aut libero reprehenderit. Tempora maiores
                        voluptate sapiente unde, deserunt ab corrupti corporis nostrum quo atque blanditiis molestias
                        voluptates laudantium ullam delectus eos nihil, aperiam magni. At quis recusandae ex illo
                        exercitationem!
                    </p>
                </div>
            </article>
            ...
            <article class="w-[70%] h-[22rem] flex flex-row justify-between items-center">
                <div id="article-content-container--left" class="w-[30rem] flex flex-col gap-4">
                    ...
                    <p id="article-text">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam ipsum qui accusantium ea! Nulla,
                        quidem! Beatae ratione enim quibusdam sequi dolorum culpa quidem voluptas iusto aliquid quo
                        provident quas autem, inventore nesciunt voluptatum obcaecati, temporibus asperiores pariatur
                        odit. Consectetur repellendus, magni minima dignissimos aut impedit. Voluptates expedita
    ...
    <footer class="w-full pt-[10vh] bg-lightblack flex flex-col justify-around items-center text-white gap-10vh">
        ...
        <style>
            ...
            .animate-scroll {
                animation: scroll
                    {{ count($images) * 5 }}s linear infinite;
            }
        </style>
        ...
        <div class="flex justify-start w-[90%]">   <p class="font-bold text-4xl">Nous contacter</p></div>
        ...
        <div class="w-[90%] h-[70vh] flex flex-row-reverse justify-between">
            ...
            <script>
                ...
                L.marker([48.8566, 2.3522]).addTo(mymap)
                    .bindPopup('Back Eats,<br> Paris')
                    .openPopup();
            </script>
            <div class="w-[40%] h-full flex justify-center items-center">
                <form class="rounded  mb-4 w-full h-full flex flex-col justify-between">
                    <div class="mb-4 h-[10%] ">
                        <input
